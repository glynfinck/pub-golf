  ...
  return (
    <Screen>
      ...
      <section>
        ...
        <Card className="gap-0 px-4 text-sm">
          <p className="text-muted-foreground">
            Payments are handled by Stripe — Apple&nbsp;Pay, Google&nbsp;Pay,
            or card — and card numbers never touch this house. Statements read{" "}
            <b className="text-foreground">PUB GOLF</b>. If something looks
            wrong on yours, write first: the club secretary can fix most
            things faster than a bank dispute can.
          </p>
        </Card>
      </section>
      ...
      <section>
        ...
        <Card className="gap-0 px-4 text-sm">
          <p className="text-muted-foreground">
            ...
            . Expect a reply within two working days — usually before your
            next round.
          </p>
        </Card>
      </section>
      ...
      <p className="mt-2 text-center font-serif text-xs italic text-muted-foreground">
        A card is a bit of fun, not a contract — this page is the contract,
